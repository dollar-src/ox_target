var k=Object.defineProperty;var T=(e,t,i)=>t in e?k(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var L=(e,t,i)=>T(e,typeof t!="symbol"?t+"":t,i);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function i(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=i(s);fetch(s.href,a)}})();async function u(e,t,i){const n={method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify(t)},s=window.GetParentResourceName?window.GetParentResourceName():"ox_target";try{return await(await fetch(`https://${s}/${e}`,n)).json()}catch(a){throw a}}function P(){this.style.pointerEvents="none",u("select",[this.targetType,this.targetId,this.zoneId]),setTimeout(()=>this.style.pointerEvents="auto",100)}function B(e,t,i,n){const s=document.getElementById("options-wrapper");if(!s||t.hide)return;const a=document.createElement("div"),o=`<i class="fa-fw ${t.icon} option-icon" ${t.iconColor?`style="color:${t.iconColor} !important"`:""}"></i>`;a.innerHTML=`${o}<p class="option-label">${t.label}</p>`,a.className="option-container",a.targetType=e,a.targetId=i,a.zoneId=n,a.addEventListener("click",P),s.appendChild(a)}const S={theme:"cheat",scale:"M",lineStyle:"l-shape",transparency:.65,showCenterCursor:!0,accentColor:"#a19ffb",glowIntensity:1,animationSpeed:.25,enableSounds:!0,borderRadius:4,borderWidth:1,layoutStyle:"classic",fontColor:"#ffffff",fontWeight:"400",fontSize:13,cardBgMode:"solid",hoverStyle:"slide",iconSize:14,letterSpacing:0,textTransform:"uppercase"};class z{constructor(){L(this,"settings");let t=null;try{const i=localStorage.getItem("ox_target_settings");i&&(t=JSON.parse(i))}catch{}this.settings=t?{...S,...t}:{...S},this.applySettings()}get current(){return this.settings}update(t){this.settings={...this.settings,...t},localStorage.setItem("ox_target_settings",JSON.stringify(this.settings)),this.applySettings(),u("updateSettings",this.settings).catch(()=>{})}reset(t){this.settings={...S},localStorage.removeItem("ox_target_settings"),this.applySettings(),u("updateSettings",this.settings).catch(()=>{}),t&&t()}applySettings(){const t=document.documentElement,i=this.settings.accentColor||"#a19ffb";t.style.setProperty("--color-accent",i);const n=i.replace("#",""),s=parseInt(n.substring(0,2),16),a=parseInt(n.substring(2,4),16),o=parseInt(n.substring(4,6),16),g=document.getElementById("accent-color-picker");g&&(g.value=i);const p=document.getElementById("font-color-picker");p&&(p.value=this.settings.fontColor),t.style.setProperty("--color-accent-dim",`rgba(${s}, ${a}, ${o}, 0.35)`),t.style.setProperty("--color-accent-glow",`rgba(${s}, ${a}, ${o}, ${.18*this.settings.glowIntensity})`);let d=this.settings.transparency;this.settings.theme==="glass"&&(d=.4),t.style.setProperty("--color-bg-card",`rgba(10, 10, 18, ${d})`),t.style.setProperty("--color-text",this.settings.fontColor),t.style.setProperty("--font-weight",this.settings.fontWeight),t.style.setProperty("--font-size",`${this.settings.fontSize}px`),t.style.setProperty("--border-radius",`${this.settings.borderRadius}px`),t.style.setProperty("--border-width",`${this.settings.borderWidth}px`),t.style.setProperty("--anim-speed",`${this.settings.animationSpeed}s`),t.style.setProperty("--glow-blur",`${15*this.settings.glowIntensity}px`);const y={XS:"0.75",S:"0.85",M:"1.0",L:"1.15",XL:"1.3"};t.style.setProperty("--ui-scale",y[this.settings.scale||"M"]||"1.0"),t.style.setProperty("--icon-size",`${this.settings.iconSize||14}px`),t.style.setProperty("--letter-spacing",`${this.settings.letterSpacing||0}px`),document.body.setAttribute("data-layout",this.settings.layoutStyle||"classic"),document.body.setAttribute("data-theme",this.settings.theme||"cheat"),document.body.setAttribute("data-card-bg",this.settings.cardBgMode||"solid"),document.body.setAttribute("data-hover-style",this.settings.hoverStyle||"slide"),document.body.setAttribute("data-text-transform",this.settings.textTransform||"uppercase")}}class ${static buildApp(){const t=document.getElementById("app");t&&(t.innerHTML=`
    ...
    `)}}$.buildApp();const r=new z;u("updateSettings",r.current).catch(()=>{});const f=document.getElementById("options-wrapper"),l=document.getElementById("menu-card"),I=document.getElementById("center-cursor"),v=document.getElementById("settings-container"),M=document.getElementById("card-header"),E=document.getElementById("back-button"),c=document.body;let h=[],w=[];window.addEventListener("message",e=>{const t=e.data;switch(t.event){case"visible":c.style.visibility=t.state?"visible":"hidden",r.current.showCenterCursor?I.style.display=t.state?"flex":"none":I.style.display="none",t.state||m();return;case"openSettings":c.style.visibility="visible",c.classList.add("in-settings"),v.style.display="flex";const i=document.getElementById("preview-anchor");i&&l&&i.appendChild(l),A(),f.innerHTML===""&&b([{type:"global",data:{icon:"fa-solid fa-eye",label:"Visual Preview",hide:!1},id:1},{type:"entity",data:{icon:"fa-solid fa-palette",label:"Live Color Test",hide:!1},id:2},{type:"zone",data:{icon:"fa-solid fa-font",label:"Typography Test",hide:!1},id:3}]);return;case"setTarget":{const o=[];if(t.options)for(const[g,p]of Object.entries(t.options))p.forEach((d,y)=>{d.hide||o.push({type:g,data:d,id:y+1})});t.zones&&t.zones.forEach((g,p)=>{g.forEach((d,y)=>{d.hide||o.push({type:"zones",data:d,id:y+1,zoneId:p+1})})}),w.length>0&&h.push([...w]),b(o);return}case"leftTarget":m();return;case"setWorldTarget":m();const n=(t.options||[]).map(o=>({type:o.type,data:o,id:o.id,zoneId:o.zoneId??null}));b(n);return;case"worldPosition":if(t.x===void 0||t.y===void 0)return;const s=t.x*window.innerWidth,a=t.y*window.innerHeight;l.style.left=s+6+"px",l.style.top=a-16+"px";return}});function b(e){if(f.innerHTML="",w=e,e.forEach(t=>{B(t.type,t.data,t.id,t.zoneId||null)}),e.length>0){l.style.display="flex",M.style.display=h.length>0?"block":"none";const t=document.getElementById("scroll-indicator");t&&(t.style.display=f.scrollHeight>f.clientHeight?"block":"none")}else l.style.display="none"}function m(){l.style.display="none",f.innerHTML="",v.style.display="none",c.classList.remove("in-settings"),h=[],w=[];const e=document.getElementById("app");e&&l&&l.parentElement!==e&&e.appendChild(l)}E==null||E.addEventListener("click",()=>{if(h.length>0){const e=h.pop();e&&b(e)}});var C;(C=document.getElementById("close-settings"))==null||C.addEventListener("click",()=>{m(),u("closeSettings").catch(()=>{})});window.addEventListener("keydown",e=>{e.key==="Escape"&&v.style.display==="flex"&&(m(),u("closeSettings").catch(()=>{}))});var x;(x=document.getElementById("reset-settings"))==null||x.addEventListener("click",()=>{r.reset(()=>{A()})});document.querySelectorAll(".sidebar-item").forEach(e=>{e.addEventListener("click",()=>{document.querySelectorAll(".sidebar-item").forEach(n=>n.classList.remove("active")),document.querySelectorAll(".settings-content").forEach(n=>n.style.display="none"),e.classList.add("active");const t=e.getAttribute("data-tab-link"),i=document.getElementById(`tab-${t}`);i&&(i.style.display="flex")})});document.querySelectorAll(".color-picker-input").forEach(e=>{const t=e.getAttribute("data-setting");e.addEventListener("input",i=>{const n=i.target.value;r.update({[t]:n})})});document.querySelectorAll(".segmented-control").forEach(e=>{const t=e.getAttribute("data-setting");e.querySelectorAll(".segment").forEach(i=>{i.addEventListener("click",()=>{e.querySelectorAll(".segment").forEach(s=>s.classList.remove("active")),i.classList.add("active");const n=i.getAttribute("data-val");r.update({[t]:n})})})});document.querySelectorAll("input[type=range]").forEach(e=>{const t=e.getAttribute("data-setting");e.addEventListener("input",i=>{const n=parseFloat(i.target.value);r.update({[t]:n})})});document.querySelectorAll(".toggle-switch").forEach(e=>{const t=e.getAttribute("data-setting");e.addEventListener("click",()=>{const i=e.classList.toggle("active");r.update({[t]:i})})});window.invokeNative||(c.style.visibility="visible",c.classList.add("debug-bg"),window.addEventListener("keydown",e=>{if(e.key.toLowerCase()==="s"){const t=v.style.display==="flex";v.style.display=t?"none":"flex",t?c.classList.remove("in-settings"):c.classList.add("in-settings")}}),setTimeout(()=>{window.postMessage({event:"setWorldTarget",options:[{icon:"fa-solid fa-folder",label:"Example Menu >",type:"global",id:1},{icon:"fa-solid fa-car",label:"Option 2",type:"entity",id:2}]},"*"),c.classList.add("in-settings"),v.style.display="flex",window.postMessage({event:"worldPosition",x:.6,y:.4},"*")},200));function A(){const e=r.current;document.querySelectorAll("input[type=range]").forEach(n=>{const s=n.getAttribute("data-setting");s&&e[s]!==void 0&&(n.value=String(e[s]))}),document.querySelectorAll(".segmented-control").forEach(n=>{const s=n.getAttribute("data-setting");s&&e[s]!==void 0&&n.querySelectorAll(".segment").forEach(a=>{a.getAttribute("data-val")===String(e[s])?a.classList.add("active"):a.classList.remove("active")})}),document.querySelectorAll(".toggle-switch").forEach(n=>{const s=n.getAttribute("data-setting");s&&e[s]!==void 0&&(e[s]?n.classList.add("active"):n.classList.remove("active"))});const t=document.getElementById("accent-color-picker");t&&(t.value=e.accentColor||"#a19ffb");const i=document.getElementById("font-color-picker");i&&(i.value=e.fontColor||"#ffffff")}
